...
console.warn(`
Pct 4 Folosind functia calculateRectangleArea()
afiseaza suprafata unui dreptunghi de 12 pe 9
`);
console.log(calculateRectangleArea(12, 9));

console.warn(`
Pct 5 Afiseaza suprafata totala a trei dreptunghiuri de 15 pe 31,
...
let totalSurface = rectangleSurface1 + rectangleSurface2 + rectangleSurface3;
console.log(totalSurface);

console.warn(`
Pct 6 Calculeaza intr-o variabila numita anotherSquare aria unui patrat de 8 pe 8.
`);
