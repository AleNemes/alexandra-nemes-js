...
pozitiile impare ale arrayului.
`);
...
person.friends.forEach((friend, i, friends) => {
  ...
  // let punctuation = i === friends.length -1 ? '.' : i === friends.length - 2 'si' : ','
...
persoanele din arrayul friends, doar daca au varsta mai
...
`);
// revrese is a mutating operation
